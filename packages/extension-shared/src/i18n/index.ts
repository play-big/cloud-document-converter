...
export const setupI18n = async (options: SetupI18nOptions): Promise<void> => {
  const { language, additionalResources = {} } = options
  ...
  await i18next.init({
    ...
    resources: {
      en: {
        translation: {
          ...en,
          ...additionalResources.en,
        },
      },
      zh: {
        translation: {
          ...zh,
          ...additionalResources.zh,
        },
      },
    },
  })
